...
def fit(self, X, s, cross_similarity, y=None, **kwargs):
    """
    ...
    self.silhouette_score_ = s
    self.silhouette_samples_ = silhouette_samples(cross_similarity, labels, metric='precomputed')
